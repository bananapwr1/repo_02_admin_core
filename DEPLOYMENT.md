...
## 🔑 Шаг 3: Получение OpenAI API Key (опционально)

Если вы хотите использовать AI-чат для разработки стратегий:
...
> **Важно:** Без OpenAI API Key AI-функции будут недоступны, но остальной функционал бота работает полностью.

## 💻 Шаг 4: Установка на локальной машине
